  ...
  return (
    <>
      <Dialog open={open} as="div" className="relative z-10" onClose={() => setOpen(false)}>
        <DialogBackdrop className="fixed inset-0 bg-gray-500 bg-opacity-75 transitiona-opacity"/>
            ...
            >
              ...
              <div className="px-6 py-4 flex justify-end gap-4">
                <button
                  ...
                  type="button"
                  className="px-4 py-2 text-sm font-semibold text-slate-800 hover:border-slate-800 rounded-md"
                >
                  Close
                </button>
              </div>
